...
Grammar = (function() {
  ...
  Grammar.prototype.makeExpression = function(groupId, productionId, data) {
    var ref, ref1;
    if (data != null) {
      return (ref = this.productions[groupId]) != null ? ref[productionId].withData(data) : void 0;
    } else {
      return (ref1 = this.productions[groupId]) != null ? ref1[productionId] : void 0;
    }
  };
...
Expression = (function() {
  ...
  Expression.prototype.display = function() {
    return this.pieces.map(function(sym) {
      return sym.display();
    }).join('');
  };

  Expression.prototype.templateString = function() {
    return this.display();
  };
...
Piece = (function() {
  ...
  Piece.make = function(type, data, quantifier) {
    if (quantifier == null) {
      quantifier = 'one';
    }
    switch (type) {
      case 'literal':
        return new Literal(data.text, quantifier);
      case 'hole':
        return new Hole(data.identifier, data.group, quantifier);
      case 'subexpression':
        return new Subexpression(data.expression, quantifier);
    }
  };
...
Literal = (function(superClass) {
  ...
  function Literal(text, quantifier1) {
    this.text = text;
...
Hole = (function(superClass) {
  ...
  function Hole(identifier, group, quantifier1) {
  ...
  Hole.prototype.display = function() {
    return "<" + this.identifier + ":" + this.group + ">";
  };
...
Subexpression = (function(superClass) {
  ...
  function Subexpression(expression, quantifier1, identifier) {
  ...
  Subexpression.prototype.display = function() {
...
ref = require('Grammar'), Expression = ref.Expression, Grammar = ref.Grammar, Piece = ref.Piece, Literal = ref.Literal, Hole = ref.Hole, Subexpression = ref.Subexpression;
...
SyntaxTree = (function() {
  ...
  SyntaxTree.prototype.dispatchEvent = function(kind, details) {
    var ref1, ref2;
    if ((ref1 = this._listeners[kind]) != null) {
      ref1.forEach(function(cb) {
        return typeof cb === "function" ? cb(details) : void 0;
      });
    }
    return (ref2 = this._eventParent) != null ? ref2.dispatchEvent(kind, details) : void 0;
  };

  SyntaxTree.prototype.routeEvents = function(parent) {
    return this._eventParent = parent;
  };

  SyntaxTree.prototype.flatten = function() {
...
Node = (function() {
   ...
   */
  function Node(parent, holeId, template) {
    this.dispatchEvent = bind(this.dispatchEvent, this);
  ...
  Node.makeRoot = function(template) {
    var result;
    result = new Node();
  ...
  Node.prototype.fill = function(template) {
    this._setTemplate(template);
  ...
  Node.prototype.navigateExpression = function(path) {
    var helper;
    helper = (function(_this) {
      return function(path, info) {
        var hd, instance, outerInfo, tl;
        if (path.length === 0) {
          return info;
        } else {
          hd = path[0], tl = 2 <= path.length ? slice.call(path, 1) : [];
          outerInfo = (function() {
            switch (hd.type) {
              case 'hole':
                return info.holes[hd.identifier];
              case 'subexpression':
                return info.subexpressions[hd.identifier];
            }
          })();
          if (outerInfo == null) {
            return void 0;
          ...
          if (tl.length === 0) {
            ...
            switch (hd.type) {
              case 'hole':
                return instance.navigateExpression(tl);
              case 'subexpression':
                return helper(tl, instance);
            }
          }
        }
      };
    })(this);
    return helper(path, this._instanceInfo);
  };
  ...
  Node.prototype.flatten = function() {
    ...
    return this.template.pieces.reduce(reduction(this._instanceInfo), []);
  };
  ...
  Node.prototype._getChild = function(id) {
    var ref1;
    return (ref1 = this.childrenMap) != null ? ref1[id] : void 0;
  };
  ...
  Node.prototype._makeSubexprId = function(n) {
    return "s" + n;
  };
  ...
  Node.prototype._setTemplate = function(template) {
    ...
    this.childrenMap = {};
    parentNode = this;
    makeHoleInfo = function(subexprPath) {
      var subexprIndex;
      subexprIndex = 0;
    ...
    this._holes = template.pieces.reduce(makeHoleInfo([]), {});
...
ModeManager = (function() {
  ...
  ModeManager.prototype.setMode = function(modeName, data) {
    ...
    console.log(this.mode + "\t->\t" + modeName);
...
describe('syntax trees', function() {
    ...
    this.rules = _.mapValues(litRules, function(vo) {
      return _.mapValues(vo, function(vi) {
        ...
        parseHelper = function(arg) {
          ...
          type = arg.type, value = arg.value, id = arg.id, quantifier = arg.quantifier;
          switch (type) {
            case 'expression':
  ...
  it('can create holed nodes', function() {
    var numNode;
    numNode = Node.makeRoot(this.grammar.makeExpression('NE', 'num-lit'));
  ...
  it('can fill quantified subexpressions', function() {
  ...
  return it('can flatten nodes', function() {
    var elementPath, flattened, path1;
    this.tree.root.fill(this.grammar.makeExpression('NE', 'list'));
    path1 = [this.pathElm('hole', 'start', 0), this.pathElm('hole', 'element')];
    this.tree.navigateExpression(path1).pushEmpty();
    elementPath = (function(_this) {
    ...
    this.tree.navigateExpression(path1).pushEmpty();
    this.tree.navigateExpression(elementPath(1)).fill(this.grammar.makeExpression('NE', 'num-lit'));
    flattened = this.tree.root.flatten();
    expect(flattened[0].type).toBe('literal');
    expect(flattened[1].type).toBe('hole');
    expect(flattened[1].isFilled).toBe(true);
    expect(flattened[1].value[0].type).toBe('literal');
    expect(flattened[1].value[0].value).toBe('(arith ');
    return expect(flattened[1].value.length).toBe(7);
  });
});
